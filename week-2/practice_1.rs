fn main(){
	...
	println!("1. Distinguish beteen computer and computer programming,/n
			  2. Develop some techniques in computer science,/n
			  3. Understand the different ares of study in computer science,/n
			  4. Conversant with applications of computer science,/n
			  5. Navigate the career prospects in cpmuter science,/n
